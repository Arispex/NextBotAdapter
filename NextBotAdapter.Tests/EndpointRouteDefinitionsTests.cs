...
public sealed class EndpointRouteDefinitionsTests
{
    ...
    [InlineData(EndpointRoutes.UserMapImage, "/nextbot/users/{user}/map-image")]
    ...
    [InlineData(EndpointRoutes.WorldExploredMapImage, "/nextbot/world/explored-map-image")]
    ...
    [InlineData(EndpointRoutes.LeaderboardMapExploration, "/nextbot/leaderboards/map-exploration")]
    [InlineData(EndpointRoutes.SecurityConfirmLogin, "/nextbot/security/confirm-login/{user}")]
    [InlineData(EndpointRoutes.Blacklist, "/nextbot/blacklist")]
    [InlineData(EndpointRoutes.BlacklistAddUser, "/nextbot/blacklist/add/{user}")]
    [InlineData(EndpointRoutes.BlacklistRemoveUser, "/nextbot/blacklist/remove/{user}")]
    ...
    [InlineData(Permissions.UserMapImage, "nextbot.users.map_image")]
    [InlineData(Permissions.WorldProgress, "nextbot.world.progress")]
    [InlineData(Permissions.WorldMapImage, "nextbot.world.map_image")]
    [InlineData(Permissions.WorldExploredMapImage, "nextbot.world.explored_map_image")]
    ...
    [InlineData(Permissions.LeaderboardMapExploration, "nextbot.leaderboards.map_exploration")]
    [InlineData(Permissions.SecurityConfirmLogin, "nextbot.security.confirm_login")]
    [InlineData(Permissions.BlacklistView, "nextbot.blacklist.view")]
    [InlineData(Permissions.BlacklistAdd, "nextbot.blacklist.add")]
    [InlineData(Permissions.BlacklistRemove, "nextbot.blacklist.remove")]
