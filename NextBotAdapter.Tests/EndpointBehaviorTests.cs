...
public sealed class EndpointBehaviorTests
{
    ...
    public void CreateCommands_ShouldReturnAllRoutesWithExpectedMetadata()
    {
        ...
        Assert.Collection(
            ...
            command => AssertRoute(command, EndpointRoutes.UserMapImage, Permissions.UserMapImage),
            ...
            command => AssertRoute(command, EndpointRoutes.WorldExploredMapImage, Permissions.WorldExploredMapImage),
            ...
            command => AssertRoute(command, EndpointRoutes.Blacklist, Permissions.BlacklistView),
            command => AssertRoute(command, EndpointRoutes.BlacklistAddUser, Permissions.BlacklistAdd),
            command => AssertRoute(command, EndpointRoutes.BlacklistRemoveUser, Permissions.BlacklistRemove),
