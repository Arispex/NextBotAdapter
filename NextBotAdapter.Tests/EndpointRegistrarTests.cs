...
public sealed class EndpointRegistrarTests
{
    ...
    public void Register_ShouldAddAllCommandsToRestInstance()
    {
        ...
        Assert.Collection(
            ...
            command => AssertRoute(command, EndpointRoutes.Blacklist, NextBotAdapter.Infrastructure.Permissions.BlacklistView),
            command => AssertRoute(command, EndpointRoutes.BlacklistAddUser, NextBotAdapter.Infrastructure.Permissions.BlacklistAdd),
            command => AssertRoute(command, EndpointRoutes.BlacklistRemoveUser, NextBotAdapter.Infrastructure.Permissions.BlacklistRemove),
