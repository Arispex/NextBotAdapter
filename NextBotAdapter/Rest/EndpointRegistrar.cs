...
public static class EndpointRegistrar
{
    public static IReadOnlyList<RestCommand> CreateCommands()
    {
        ...
        [
            ...
            new SecureRestCommand(Infrastructure.EndpointRoutes.UserMapImage, UserEndpoints.MapImage, Infrastructure.Permissions.UserMapImage),
            ...
            new SecureRestCommand(Infrastructure.EndpointRoutes.WorldExploredMapImage, MapEndpoints.ExploredImage, Infrastructure.Permissions.WorldExploredMapImage),
            ...
            new SecureRestCommand(Infrastructure.EndpointRoutes.Blacklist, BlacklistEndpoints.List, Infrastructure.Permissions.BlacklistView),
            new SecureRestCommand(Infrastructure.EndpointRoutes.BlacklistAddUser, BlacklistEndpoints.Add, Infrastructure.Permissions.BlacklistAdd),
            new SecureRestCommand(Infrastructure.EndpointRoutes.BlacklistRemoveUser, BlacklistEndpoints.Remove, Infrastructure.Permissions.BlacklistRemove),
            ...
            new SecureRestCommand(Infrastructure.EndpointRoutes.LeaderboardMapExploration, LeaderboardEndpoints.MapExploration, Infrastructure.Permissions.LeaderboardMapExploration),
