...
{
    public static NextBotAdapterConfig Default { get; } = new(NextBotSettings.Default, WhitelistSettings.Default, BlacklistSettings.Default, SyncSettings.Default, LoginConfirmationSettings.Default, "我的服务器");
